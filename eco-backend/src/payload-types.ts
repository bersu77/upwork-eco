...
export interface Config {
  ...
  collectionsSelect: {
    ...
    facets: FacetsSelect<false> | FacetsSelect<true>;
    facetValues: FacetValuesSelect<false> | FacetValuesSelect<true>;
...
export interface Product {
  ...
  facetValues?: (number | FacetValue)[] | null;
  /**
...
export interface Category {
  ...
  title: string;
  /**
   * Category description for display on collection pages
   */
  description?: string | null;
  /**
   * Featured image displayed on collection cards and pages
   */
  featuredAsset?: (number | null) | Media;
  /**
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "facetValues".
 */
export interface FacetValue {
  id: number;
  /**
   * The display name of this facet value (e.g., "Red", "Large", "Nike")
   */
  name: string;
  /**
   * A unique code for this value (e.g., "red", "large", "nike")
   */
  code: string;
  /**
   * The facet this value belongs to
   */
  facet: number | Facet;
  /**
   * When enabled, the slug will auto-generate from the title field on save and autosave.
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "facets".
 */
export interface Facet {
  id: number;
  /**
   * The display name of this facet (e.g., "Color", "Size", "Brand")
   */
  name: string;
  /**
   * A unique code for this facet (e.g., "color", "size", "brand")
   */
  code: string;
  /**
   * When enabled, the slug will auto-generate from the title field on save and autosave.
...
export interface Cart {
  ...
  currency?: 'USD' | null;
  status?: ('active' | 'PaymentAuthorized' | 'purchased' | 'abandoned' | 'completed') | null;
  shippingAddress?: (number | null) | Address;
  billingAddress?: (number | null) | Address;
  shippingMethod?: (number | null) | ShippingMethod;
  /**
   * Payment records for this cart
   */
  payments?:
    | {
        method: string;
        amount: number;
        state: 'Pending' | 'Authorized' | 'Settled' | 'Failed';
...
export interface Address {
  ...
  phone?: string | null;
  /**
   * Full name for the address (alternative to firstName + lastName)
   */
...
export interface ShippingMethod {
  id: number;
  /**
   * The display name (e.g., "Standard Shipping", "Express Delivery")
   */
  name: string;
  /**
   * A unique code for this shipping method (e.g., "standard", "express")
   */
  code: string;
  /**
  ...
  description?: string | null;
  /**
   * The cost of this shipping method in USD
   */
  price: number;
  /**
   * Number of days for delivery (optional)
   */
  estimatedDays?: number | null;
  /**
   * Whether this shipping method is available for customers
   */
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "facets_select".
 */
export interface FacetsSelect<T extends boolean = true> {
  name?: T;
  code?: T;
  generateSlug?: T;
  slug?: T;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "facetValues_select".
 */
export interface FacetValuesSelect<T extends boolean = true> {
  name?: T;
  code?: T;
  facet?: T;
  generateSlug?: T;
